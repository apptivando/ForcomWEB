...
const MIRRORED = [
  ...
  ["019_whatsapp_del_formulario.sql", "el WhatsApp del formulario cuenta como confirmado (26/08/2026)"],
  ["020_backfill_fichas_formulario.sql", "ficha de cliente para los leads de producción (24/09/2026)"],
];

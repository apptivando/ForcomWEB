...
export default function Hero({ data }: { data?: HeroContent | null }) {
  ...
  return (
    <section className="relative min-h-screen flex items-start hero-gradient grid-bg overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full pt-24 pb-16 lg:pt-36">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          {/* Left: Copy */}
          <div className="max-w-xl">
            {/* Eyebrow */}
            <div className="animate-fade-in-up flex items-center gap-3 mb-6" style={{ animationDelay: "0.1s" }}>
            ...
            {/* Headline */}
            <h1
              className="animate-fade-in-up font-display font-extrabold text-5xl sm:text-6xl lg:text-7xl leading-[0.95] tracking-tight text-white mb-6"
            ...
            >
              ...
              {h.headline_line2}
              <br />
              <span className="text-forcom-red">{h.headline_red}</span>
            </h1>

            {/* Subhead */}
            <p
              className="animate-fade-in-up text-forcom-gray-light text-lg lg:text-xl leading-relaxed mb-10 max-w-md"
            ...
            {/* CTAs */}
            <div className="animate-fade-in-up flex flex-col sm:flex-row gap-4" style={{ animationDelay: "0.55s" }}>
              <a
                href="#productos"
            ...
            {/* Trust bar */}
            <div className="animate-fade-in mt-16 flex items-center gap-6 text-forcom-gray text-sm" style={{ animationDelay: "0.7s" }}>
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 bg-green-500 rounded-full" />
                <span>{h.trust_item_1}</span>
              </div>
              <div className="w-px h-4 bg-forcom-border" />
          ...
          <div className="animate-scale-in relative hidden lg:flex items-center justify-center" style={{ animationDelay: "0.5s" }}>
            <div className="relative w-full max-w-lg aspect-square">
              ...
              {h.hero_image_url ? (
                ...
                <div className="absolute inset-4 bg-gradient-to-br from-forcom-card to-forcom-dark rounded-sm border border-forcom-border/60 overflow-hidden flex items-center justify-center p-6">
                  <img
                ...
                <div className="absolute inset-4 bg-gradient-to-br from-forcom-card to-forcom-dark rounded-sm border border-forcom-border/60 flex items-center justify-center overflow-hidden">
                  ...
                  <div className="absolute top-8 -right-2 px-3 py-1.5 bg-forcom-red/10 border border-forcom-red/30 rounded-sm text-xs font-display font-semibold text-forcom-red tracking-wider">
                    INTEL CORE i7
                  </div>

...
export default function PasswordResetRequest({ initialEmail = "" }: { initialEmail?: string }) {
  ...
  if (sent) {
    return (
      <>
        ...
        <Link href="/admin/login" className="inline-block text-sm text-[#E8231A] hover:underline">
  ...
  return (
    <>
      ...
      <p className="text-sm text-[#8A8A8A] mt-6">
        <Link href="/admin/login" className="text-[#E8231A] hover:underline">
          Volver al inicio de sesión
        </Link>
      </p>
    </>
